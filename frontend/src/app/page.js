...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Categories Section */}
      <section className="py-20 bg-vintage-dark">
      ...
      {/* Featured Products */}
      <section className="py-20 bg-gradient-to-b from-vintage-dark to-vintage-dark/95">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display text-4xl text-vintage-cream mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.slice(0, 8).map((product) => (
              <div key={product.id} className="vintage-card group">
      ...
      {/* Newsletter Section */}
      <section className="py-20 bg-gradient-to-r from-wine-burgundy/20 via-vintage-dark to-gold/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
